...
@section('header')
    ...
    <!-- Header -->
    <header class="header text-white h-fullscreen pb-80" style="background-image: url({{url('storage/'.$post->image)}});" data-overlay="9">
                    ...
                    <div class="col-lg-8 mx-auto">
                        ...
                        <script>
                            ...
                            (function() { // DON'T EDIT BELOW THIS LINE
                                ...
                                s.src = 'https://sass-blog-19.disqus.com/embed.js';
